...
struct StoryBrain{
    ...
    mutating func nextStory(_ input: String){       
        if input == getCurrentStory().choice1{
            storyNumber = getCurrentStory().choice1Destination
        } else if input == getCurrentStory().choice2{
            storyNumber = getCurrentStory().choice2Destination
        }
    }
